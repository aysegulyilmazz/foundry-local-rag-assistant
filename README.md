...
# \- `knowledge\_base.py` — Devlet yardımları bilgi tabanı (12 belge)

# \- `setup\_db.py` — Belgeleri vektörleştirip SQLite'a kaydeden kurulum betiği

# \- `embed\_text.py` — Metinleri vektöre çeviren yardımcı betik (ayrı process)

# \- `rag\_utils.py` — Çekirdek RAG fonksiyonları (hybrid search, query rewriting, ingestion, loglama)
...
# \- `test\_rag.py` — pytest birim testleri
